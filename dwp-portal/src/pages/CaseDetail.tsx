    ...
    <div className="container">
      ...
      <header className="page-header">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          {detail.slaBreached && <span className="badge badge-red">SLA exceeded</span>}
        </div>
      </header>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        <div className="grid">
          <div className="mini-card">
            <div className="mini-label">NI</div>
            <div>{detail.niNumber || '—'}</div>
          </div>
          <div className="mini-card">
            <div className="mini-label">NHS ID</div>
            <div>{detail.nhsId || '—'}</div>
          </div>
          <div className="mini-card">
